...
var loadBrowsingList = function() {
	...
	for (var i = 1; i <= 3; i++) {
		...
		html += '<div class="card"><div class="card-image waves-effect waves-block waves-light"><img class="activator" src="' + imageName + '"></div><div class="card-content"><span class="card-title activator grey-text text-darken-4">Card Title<i class="material-icons right"><a class="editable">mode_edit</a></i></span></div>';
	}
